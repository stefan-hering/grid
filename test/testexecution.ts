...
suite("Executor", () => {
    ...
    test("Should execute the 99 bottles grid", () => {
        let testgrid : string = fs.readFileSync("test/grids/99bottles.grid", "utf8");
        let parsedGrid : g.Grid = parseWholeGrid(readGrid(testgrid));
        new Analyzer(parsedGrid).analyzeGrid();

        let expectedResult = "99 bottles of beer on the wall, 99 bottles of beer.\n"+
